...
interface ExposedNewsProps {
  locale: Locale
}

export default async function ExposedNews({ locale }: ExposedNewsProps) {
  ...
  return <CardCarouselSectionThree className="-mt-18 bg-secondary/20" cards={cards} />
}
