  ...
  return (
    <InputGroup className={cn("w-auto", className)}>
      <ComboboxPrimitive.Input
        render={
          <InputGroupInput disabled={disabled} className={cn(inputClassName)} />
        }
        {...props}
      />
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent border-none"
            disabled={disabled}
          >
            <ComboboxTrigger />
          </InputGroupButton>
